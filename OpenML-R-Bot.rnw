...
\color{red}Zu viel Fokus auf Metalearning? \color{black}
...
<<datasets, echo = FALSE, results="asis",  fig.pos='htb!' , message = FALSE, fig.lp="fig:">>=
  ...
  tab = tasks[, c("Data_id", "Name", "nObs", "nFeat", "majPerc", "numFeat", "factFeat")]
  
  print(xtable(tab, caption = "Included datasets, number of observations (nObs), 
    number of features (nFeat), majority class size percentage (majorPerc), 
    number of numerical features (numFeat) and number of factor features (factFeat) ", digits = 0, label = "tab:datasets"), digits = 0, include.rownames=FALSE, size = "scriptsize")
@
...
\color{red} Ueberarbeiten \color{black}
...
<<datasets_nr, echo = FALSE, results="asis",  fig.pos='htb!' , message = FALSE, fig.lp="fig:">>=
  ...
  print(xtable(tab, caption = "Number of results by dataset and algorithm", digits = 0, label = "tab:datasets"), digits = 0, include.rownames=FALSE, size = "scriptsize", hline.after = c(-1, 0, nrow(tab)-1, nrow(tab)))
@
